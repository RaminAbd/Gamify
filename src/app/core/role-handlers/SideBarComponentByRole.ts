...
import { ParticipantNavigationBarComponent } from '../../components/navigation-bars/participant-navigation-bar/participant-navigation-bar.component';
...
export const SideBarComponentByRole = {
  ...
  ROLE_PARTICIPANT: ParticipantNavigationBarComponent,
};
